...
```bash
    sudo mkdir /home/airflow && cd /home/airflow && sudo git clone https://github.com/nico-its/airflow.git && cd airflow && sudo chmod 755 Preparation.sh ./terraform-airflow/airflow.sh && ./Preparation.sh
```
